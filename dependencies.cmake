...
set(keccak_INCLUDE_DIR ${keccak_SOURCE_DIR}/bin/generic64)
set(keccak_LINK_DIR    ${keccak_SOURCE_DIR}/bin/generic64)

# it is used to rename libkeccak.a.headers to keccak. 
# we want namespaced include: #include <keccak/blablasha.h>
add_custom_command(
  TARGET keccak
  POST_BUILD
  COMMAND mv ${keccak_LINK_DIR}/libkeccak.a.headers ${keccak_LINK_DIR}/keccak
  COMMENT "mv libkeccak.a.headers keccak"
)
