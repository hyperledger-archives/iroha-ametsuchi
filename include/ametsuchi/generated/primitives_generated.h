...
#ifndef FLATBUFFERS_GENERATED_PRIMITIVES_IROHA_API_H_
#define FLATBUFFERS_GENERATED_PRIMITIVES_IROHA_API_H_
...
struct Peer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const iroha::api::PublicKey *publicKey() const {
    return GetPointer<const iroha::api::PublicKey *>(VT_PUBLICKEY);
  }
...
struct PeerBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_publicKey(flatbuffers::Offset<iroha::api::PublicKey> publicKey) {
...
inline flatbuffers::Offset<Peer> CreatePeer(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<iroha::api::PublicKey> publicKey = 0,
...
#endif  // FLATBUFFERS_GENERATED_PRIMITIVES_IROHA_API_H_
