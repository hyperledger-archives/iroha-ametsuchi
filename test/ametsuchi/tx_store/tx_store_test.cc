...
class TXStoreTest : public ::testing::Test {
 protected:
  TXStoreTest() : array_(array_path), index_(index_path) {}
...
TEST_F(TXStoreTest, ArrayIndex) {
  ...
  auto i1 = index_.append(array_.append(a1));
  auto i2 = index_.append(array_.append(a2));

  ByteArray at1 = array_.get(index_.get(i1)),
    at2 = array_.get(index_.get(i2));
