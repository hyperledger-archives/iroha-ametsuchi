...
namespace ametsuchi {
  ...
  namespace impl {
    ...
    Ametsuchi::Ametsuchi() {
      ...
      wsv_ =
          std::make_unique<wsv::PostgreSQL>("localhost", 5432, "postgres", "");
    }
    ...
    std::experimental::optional<uint64_t> Ametsuchi::get_tx_id(
        const std::string &hash) {
    ...
    std::experimental::optional<uint64_t> Ametsuchi::last_block_id_index() {
